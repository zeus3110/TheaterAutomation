...
public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewAdapter.ViewHolder> {
   ...
   RecyclerViewAdapter(String[] titles , TypedArray icons , Context context){
            ...
            BarTitle=((MainActivity) context).getResources().getStringArray(R.array.navDrawerItems);
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener  {
        ...
        */
        ...
        public void onClick(View v) {
            ...
            ((MainActivity) context).toolbar.setTitle(BarTitle[getPosition()-1]);
            ...
            switch (getPosition()){
                ...
                case 3:
                    ...
                    break;
                case 4:
                    Fragment FragmentSharpBD = new FragmentSharpBD();
                    fragmentTransaction.replace(R.id.containerView,FragmentSharpBD);
                    fragmentTransaction.commit();
                    break;
                case 5:
                    Fragment audiosettingFragment = new FragmentAudioSettings();
                    fragmentTransaction.replace(R.id.containerView,audiosettingFragment);
                    fragmentTransaction.commit();
                    break;
                case 6:
                    Fragment videosettingFragment = new FragmentVideoSettings();
                    fragmentTransaction.replace(R.id.containerView,videosettingFragment);
                    fragmentTransaction.commit();
                    break;
                case 7:
                    Fragment roomsettingFragment = new FragmentRoomSettings();
                    fragmentTransaction.replace(R.id.containerView,roomsettingFragment);
                    fragmentTransaction.commit();
                    break;
            }
        }
